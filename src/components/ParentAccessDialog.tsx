...
export function ParentAccessDialog({ students, groups, access, syncing, onCreateStudent, onCreateLink, onRegenerate, onDisable, onRebuild, onClose }: {
  students: Student[]; groups: Group[]; access: ParentAccess[]; syncing?: boolean;
